...
1. **Selbstregistrierung**: Eine Anfrage stellen, die von einem Administrator bestätigt wird
2. **Einladungslink**: Ein bereits bestehender Benutzer oder Administrator kann dir einen Link oder QR-Code zur Registrierung geben
...
- **Passkey**: Ein moderner Passkey, sicher auf deinem Gerät gespeichert
...
>
> ⚠️ **Firefox auf Android**: Passkeys funktionieren dort aktuell nicht zuverlässig, da Firefox für Android (im Gegensatz zu Chrome, Samsung Internet u. a.) die Android-Credential-Manager-Schnittstelle noch nicht unterstützt. Falls beim Anlegen oder Nutzen eines Passkeys kein Fingerabdruck-/Face-ID-Dialog erscheint, bitte stattdessen die Anmeldemethode **🔒 Passwort** wählen.
