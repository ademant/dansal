...
Jede Veranstaltungsseite enthält:
...
## 🎟️ Veranstaltungsinformationen

### Status einer Veranstaltung
- **✅ Veröffentlicht**: Für alle sichtbar, erscheint auf der Karte
- **❌ Abgesagt**: Veranstaltung wurde abgesagt, mit entsprechendem Hinweis angezeigt

### Preise & Buchung
- Veranstaltungen können verschiedene Preisstufen anzeigen (kostenlos, Spende, Frühbucher, regulär, Abendkasse)
- Buchungslinks führen zum Ticketsystem des Veranstalters (falls vorhanden)
